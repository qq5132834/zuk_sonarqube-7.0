 ...
 */
package org.sonar.plugins.java.demo.checkrule;
...
import org.sonar.plugins.java.demo.DemoFileCheckRegistrar;
...
public class SpringControllerRequestMappingEntityRule extends BaseTreeVisitor implements JavaFileScanner {
  ...
  public void scanFile(JavaFileScannerContext context) {
    System.out.println("huangliao.SpringControllerRequestMappingEntityRule.scanFile");
    LOG.info("huangliao.SpringControllerRequestMappingEntityRule.scanFile");
  ...
  public void visitMethod(MethodTree tree) {
    ...
    System.out.println("huangliao.SpringControllerRequestMappingEntityRule.visitMethod");
    LOG.info("huangliao.SpringControllerRequestMappingEntityRule.visitMethod");
