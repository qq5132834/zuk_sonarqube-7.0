...
public class DemoRulesDefinition implements RulesDefinition {

    private static final Logger LOG = Loggers.get(DemoRulesDefinition.class);
    ...
    public void define(Context context) {
        ...
        System.out.println("huangliao.DemoRulesDefinition.define");
        LOG.info("huangliao.DemoRulesDefinition.define");
    ...
    private void addMetadata(NewRule rule, String metadataKey) {
        URL resource = DemoRulesDefinition.class.getResource(RESOURCE_BASE_PATH + "/" + metadataKey + "_java.json");
        if (resource != null) {
    ...
    private static void addHtmlDescription(NewRule rule, String metadataKey) throws MalformedURLException {
//        URL resource = DemoRulesDefinition.class.getResource(RESOURCE_BASE_PATH + "/" + metadataKey + "_java.html");
        URL resource = new URL("D:\\development\\gitlab\\sany-electric-uniapp");
        if (resource != null) {
